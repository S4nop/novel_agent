...
implements Part ① (the agent workflow). The default model for every LLM role is
Claude Sonnet 5; all human-facing output is Korean (see config.Settings.ui_language).
